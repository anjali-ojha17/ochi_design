              ...
              <div className="w-fit flex">
                {index === 1 && (
                  <motion.div
                    ...
                    className=" mr-5 w-[8vw] h-[5vw] rounded-md relative -top-[0.5vw] bg-red-500"
                  >
                    <img
                ...
                <h1 className="flex items-center uppercase text-[8vw] h-full leading-[8vw] tracking-tight font-['Founders_Grotesk_X_Condensed'] font-semibold">
                  {item}
                </h1>
              </div>
            </div>
