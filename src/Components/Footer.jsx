...
function Footer() {
  return (
    <div className="w-full flex gap-5 h-screen bg-zinc-900 p-20 font-['Founders Grotesk_X-Condensed']">
      <div className="w-1/2 h-full flex flex-col justify-between ">
        <div className="heading">
          <h1 className="text-[7vw] tracking-tighter font-semibold uppercase leading-none -mb-6">
            Eyes-
          </h1>
          <h1 className="text-[7vw] tracking-tighter font-semibold uppercase leading-none -mb-6">
            Opening
      ...
      <div className="w-1/2">
        <h1 className="text-[6vw] tracking-tighter font-semibold uppercase leading-none mb-10">
          Presentations
        </h1>
        <div className="flex justify-between">
          <div className="flex flex-col gap-8">
            <div className="dets font-['Neue_Montreal'] flex flex-col gap-6 mt-10">
              <h3 className=" text-2xl font-light">S:</h3>
              <div className="links">
            ...
            <div className="dets font-['Neue_Montreal'] flex flex-col gap-6 mt-10">
              <h3 className=" text-2xl font-light">L:</h3>
              <div className="links">
                <a className="block text-xl font-light" href="#">
                  202-1965 W 4th Ave
                </a>
            ...
            <div className="dets font-['Neue_Montreal'] flex flex-col gap-6 mt-10">
              <h3 className=" text-2xl font-light">E:</h3>
              <div className="links">
                <a className="block text-xl font-light" href="#">
                  hello@ochi.design
                </a>
          ...
          <div className="dets font-['Neue_Montreal'] flex flex-col gap-6 mt-[12vw]">
            <h3 className=" text-2xl font-light">M:</h3>
            <div className="links">
              <a className="block text-xl font-light" href="#">
                Home
              </a>
